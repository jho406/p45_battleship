...
== Todo
The models themselves are pretty slim, so it is possible to massage them further (rename 'ships' to 'game pieces') to be used for other simple board games (lib/chess).
